...
import com.example.myapplication.table.QqInfo;
...
public class QQLoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String APP_ID = "102014981";//官方获取的APPID
            ...
            try {
                ...
                mUserInfo.getUserInfo(new IUiListener() {
                    ...
                    public void onComplete(Object response) {
                        ...
                        Gson gson=new Gson();
                        gson.fromJson(response.toString(), QqInfo.class);
                        Log.d(TAG, "登录成功" + new QqInfo().getRet());
                        if (new QqInfo().getRet()==0){
                           Intent it=new Intent();
                           it.setClass(QQLoginActivity.this,MainActivity.class);
                           startActivity(it);
                        }
